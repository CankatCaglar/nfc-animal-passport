              ...
              <div className="bg-white rounded-lg shadow-md border border-[#D9AE94] p-8">
                ...
                <div className="w-full h-64 rounded-lg mb-6 overflow-hidden">
                  <iframe
                    ...
                    src="https://www.google.com/maps?q=38.4639,27.1044&z=16&hl=en&output=embed"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                  ...
                  <div className="flex flex-wrap items-center mt-4 gap-8">
                    <div className="flex items-center min-w-[220px]">
                      <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#F1DCA7] mr-3">
                        <svg className="w-5 h-5 text-[#997B66]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                      </span>
