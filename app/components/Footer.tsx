    ...
    <footer className="bg-[#997B66] text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-[#F1DCA7]">NFC Animal Passport</h3>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-[#F1DCA7]">Quick Links</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-[#F1DCA7]">Legal</h4>
            <ul className="space-y-2">
              <li>
                <Link href="/privacy" className="text-sm text-white opacity-80 hover:text-[#F1DCA7] hover:opacity-100 transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm text-white opacity-80 hover:text-[#F1DCA7] hover:opacity-100 transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-[#F1DCA7]">Connect With Us</h4>
            <div className="flex space-x-4">
              <a href="#" className="text-white opacity-80 hover:text-[#F1DCA7] hover:opacity-100 transition-colors">
